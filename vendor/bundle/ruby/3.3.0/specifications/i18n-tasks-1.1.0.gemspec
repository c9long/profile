# -*- encoding: utf-8 -*-
# stub: i18n-tasks 1.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/glebm/i18n-tasks/blob/main/CHANGES.md", "issue_tracker" => "https://github.com/glebm/i18n-tasks", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/glebm/i18n-tasks" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<highline>.freeze, [">= 3.0.0".freeze])
  ...
  s.add_runtime_dependency(%q<ruby-progressbar>.freeze, ["~> 1.8".freeze, ">= 1.8.1".freeze])
